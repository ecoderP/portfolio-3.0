  ...
  return (
    <div id="intro" className="bg-[{Header}] bg-cover bg-center relative">
      <div
        ...
        className="intro h-3/4 w-full md:pt-[5rem] md:pb-[3rem] md:px-[0.5rem] px-[1rem] pt-[6rem] pb-[1rem] flex flex-col md:flex-row items-center justify-center relative"
      >
        <div className="intro-overlay absolute top-0 left-0 w-full h-full bg-[#292E49] opacity-70 z-0"></div>
        <p className="intro-left-greeting absolute top-17 md:top-30 left-5 md:left-40 text-2xl text-shadow-lg/40 text-[#f0f0f0] mb-2">
          Hello, I'm ...
        </p>
        ...
        <div className="intro-right md:flex-1 md:shrink h-1/3 w-full flex items-center justify-center">
          <div className="intro-right-wrapper w-3/4 p-[2rem]">
            <img
              src={Me}
              loading="lazy"
              alt="My photo"
